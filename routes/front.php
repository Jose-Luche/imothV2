...
Route::prefix('covers')->group(function () {
    ...
    Route::prefix('home')->group(function () {
        ...
        Route::post('/home', [HomeController::class, 'submitHomeDetails'])->name('front.home.submit');
        Route::get('/bio', [HomeController::class, 'userBio'])->name('front.home.bio');
        Route::post('/bio/submit', [HomeController::class, 'submitBio'])->name('front.home.bio.submit');
        Route::get('/covers/{id}', [HomeController::class, 'covers'])->name('front.home.covers');
        Route::get('/details/{applicationId}/{id}', [HomeController::class, 'coverDetails'])->name('front.home.details');
        Route::get('/submit/{applicationId}/{id}', [HomeController::class, 'submitApplication'])->name('front.home.details.submit');
        Route::post('/documents/{id}', [HomeController::class, 'uploadDocuments'])->name('front.home.upload');
        Route::get('/pay/{id}', [HomeController::class, 'pay'])->name('front.home.pay');
    });
