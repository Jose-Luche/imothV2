! function(p) {
    ...
    function(i) {
        ...
        i("#toastr-one").on("click", function(t) {
            ...
            i.NotificationApp.send("How to contribute?", ["Fork the repository", "Improve/extend the functionality", "Create a pull request"], "top-right", "#a6640a", "info")
        }), i("#toastr-six").on("click", function(t) {
            i.NotificationApp.send("To get the best our of Bold Manage?", "<a href='services'>Add Services</a>.", "top-center", "#a66f11", "info", !0)
