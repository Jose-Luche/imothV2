! function(i) {
    ...
    e.prototype.init = function() {
        i("#basic-datepicker").flatpickr(), i("#datetime-datepicker").flatpickr({
            ...
            enableTime: !0,
            dateFormat: "Y-m-d H:i"
        }),i("#basic-datepicker2").flatpickr(), i("#datetime-datepicker").flatpickr({
            enableTime: !0,
            dateFormat: "Y-m-d H:i"
        }),i("#basic-datepicker3").flatpickr(), i("#datetime-datepicker").flatpickr({
            enableTime: !0,
            dateFormat: "Y-m-d H:i"
        }),i("#dates").flatpickr(), i("#datetime-datepicker").flatpickr({
            enableTime: !0,
            dateFormat: "Y-m-d H:i"
            ...
            dateFormat: "H:i",
            time_24hr: !0
        }),i("#24hours-timepicker2").flatpickr({
            enableTime: !0,
            noCalendar: !0,
            dateFormat: "H:i",
            time_24hr: !0
