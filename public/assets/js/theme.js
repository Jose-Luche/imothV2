!(function (s) {
    ...
    var e = {
            ...
            s(".grid").each(function (t, e) {
                var e = s(e),
                    a = e.find(".isotope").imagesLoaded(function () {
                        a.isotope({ itemSelector: ".item", layoutMode: "masonry", percentPosition: !0, masonry: { columnWidth: a.width() / 12 }, transitionDuration: "0.7s" });
                    });
                            ...
                            s(".owl-item")
                                ...
                                .each(function (t, e) {
                                    ...
                                    s(this)
                                        ...
                                        .css({ "animation-delay": a + "ms", "animation-duration": o + "ms" });
                                });
                    }),
            ...
            s(".animated-captions")
                ...
                .each(function () {
                    ...
                    s(this)
                        .addClass("animate__animated")
                        .addClass(s(this).data("anim"))
                        .css({ "animation-delay": t + "ms", "animation-duration": e + "ms" });
                });
        },
        lightbox: () => {
            GLightbox({
                ...
                plyr: {
                    css: "",
                    js: "",
                    config: { ratio: "16:9", fullscreen: { enabled: !1, iosNative: !1 }, youtube: { noCookie: !0, rel: 0, showinfo: 0, iv_load_policy: 3 }, vimeo: { byline: !1, portrait: !1, title: !1, transparent: !1 } },
                },
            });
        },
        plyr: () => {
        ...
        textRotator: () => {
            null != document.querySelector(".rotator-zoom") && new ReplaceMe(document.querySelector(".rotator-zoom"), { animation: "animate__animated animate__zoomIn", speed: 2500, separator: ",", clickChange: !1, loopCount: "infinite" }),
            null != document.querySelector(".rotator-fade") &&
            new ReplaceMe(document.querySelector(".rotator-fade"), { animation: "animate__animated animate__fadeInDown", speed: 2500, separator: ",", clickChange: !1, loopCount: "infinite" });
        },
        codeSnippet: () => {
