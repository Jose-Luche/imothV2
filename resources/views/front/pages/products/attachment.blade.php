                ...
                <div class="col-lg-8">
                    <div class="single-services-details-content">
                        ...
                        <p>
                            ...
                            sure there isn't anything embarrassing the middle of text all
                ...
                <div class="col-lg-4">
                    <div class="download-app">
                        ...
                        <div class="option-item">
                            <a href="{{ route('front.attachment.index') }}" style="background-color: #0031AA; color:white" 
