            ...
            <nav class="navbar navbar-expand-lg classic transparent navbar-light">
                <div class="container flex-lg-row flex-nowrap align-items-center">
                    <div class="navbar-brand w-100">
                        <a href="/">
                            <img class="pl-20" style="max-height: 80px" src="{{ asset('images/logo-landscape2.png') }}"
                                srcset="{{ asset('images/logo-landscape2.png') }}" alt="" />
                        </a>
                    </div>
                    <div class="navbar-collapse offcanvas-nav">
                        <div class="offcanvas-header d-lg-none d-xl-none">
                            <a href="/">
                                <img style="max-height: 100px" src="{{ asset('images/logo-landscape2.png') }}"
                                    srcset="{{ asset('images/logo-landscape2.png') }}" alt="{{ env('APP_NAME') }}" />
                            </a>
                ...
                <div class="row gy-6 gy-lg-0">
                    <div class="col-md-4 col-lg-3">
                        <div class="widget">
                            <img class="" style="max-height: 70px"
                                src="{{ asset('images/logo-landscape-dark.png') }}"
                                srcset="{{ asset('images/logo-landscape-dark.png') }}" alt="" />
                            <p class="mb-1">© {{ date('Y') }} {{ env('APP_NAME') }}. <br
                                    class="d-none d-lg-block" />All rights reserved.</p>
                            <nav class="nav social social-white">
                                <a href="https://twitter.com/IMaramoja" target="_blank"><i
                                        class="uil uil-twitter"></i></a>
                                <a href="https://web.facebook.com/IMaramoja?_rdc=1&_rdr" target="_blank"><i
                                        class="uil uil-facebook-f"></i></a>
                                <a href="https://www.instagram.com/insurance_maramoja/" target="_blank"><i
                    ...
                    <div class="col-md-5 col-lg-4">
                        <div class="widget">
                            ...
                            <a href="mailto:insurance@imoth.co.ke"><span> insurance@imoth.co.ke</span></a><br />
                            +254112476114
                        </div>
                        <!-- /.widget -->
                    </div>
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="widget">
                            ...
                            <ul class="list-unstyled  mb-0">
                                ...
                                <li><a href="{{ route('front.attachment.index') }}">Industrial Attachment Insurance</a>
                                </li>
