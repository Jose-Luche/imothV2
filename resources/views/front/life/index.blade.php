...
<head>
    ...
    <meta name="description" content="Get your Life Insurance  Quote instantly,anywhere in Kenya.">
    <meta name="keywords" content="Life insurance quotation">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form method="POST" action="{{ route('front.life.bio.submit') }}" novalidate>
                            @csrf
                            <div class="row">
