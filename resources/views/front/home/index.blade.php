...
<head>
    ...
    {{--<meta name="description" content="Get your Home Insurance  Quote instantly,anywhere in Kenya.">
    <meta name="keywords" content="Home Insurance quotation, Domestic Package">
    <meta name="robots" content="index, follow" />

    <meta property="og:title" content="Home Insurance Quotation">
    <meta property="og:description" content="Get your health insurance quotation instantly in Kenya.">
    <meta property="og:url" content="https://www.imoth.co.ke/covers/home">
    <meta property="og:type" content="website">--}}
    <title>Home Insurance Quotation | Imoth Insurance Brokers, Nairobi, Kenya</title>
                                ...
                                <div class="col-lg-12 col-md-6">
                                    <div class="form-group">
                                        <select name="limit" id="limit" class="form-control" required
                                            data-error="Please Select Plan">

                                            <option value="">Select Limit</option>
                                            @foreach ($data as $row)
                                                <option value="{{ $row->limit }}">{{ number_format($row->limit) }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="help-block with-errors"></div>
