                    ...
                    <div class="contact-form">
                        ...
                        <form id="TPOForm" style="display: none" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-6">
                                    <div class="form-group">
                                        <select name="vehicleUse" class="form-control" required data-error="Please Select Vehicle Use">
                                            <option value="">--Select Vehicle Use--</option>
                                            <option value="personal">Personal/Private Use</option>
                                            <option value="psv">PSV -Chauffeur Driven</option>
                                            <option value="own-goods">Commercial - Own Goods</option>
                                ...
                                <div class="col-lg-12 col-md-6">
                                    <div class="form-group">
                                        <select name="carMake" id="motor-makes" class="form-control" required data-error="Please Select Vehicle Use">
                                            <option value="">--What is the Make of your Car--</option>
                                            @include('front.pages.quotations.motor-makes')
                                        </select>
                                        <div class="help-block with-errors"></div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="form_name">When do you want your cover to start?*</label>
                                        <input type="date" name="date" id="message" class="form-control" min="{{ date('Y-m-d') }}" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-6">
                                    <div class="form-group">
                                        <select name="policy" class="form-control" required data-error="Please Select Policy Duration">
