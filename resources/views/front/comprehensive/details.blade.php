                    ...
                    <div class="row">
                        <a href="#" class="card lift">
                            <div class="card-body p-5 d-flex flex-row">
                                <div class="p-2">
                                    <img style="max-width: 100px" src="{{ asset('frontend/assets/images/imoth.jpeg') }}">
                                </div>
                                <div>
                        ...
                        <div class="single-features-card bg-color-2">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <span onclick="alert('Coming Soon')" class="btn btn-outline-info btn-sm d-lg-block col-md-6 text-center text-body">
                                Print Quote <i class="uil uil-location-arrow"></i>
                            </span>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <a class="btn btn-outline-aqua btn-sm rounded-pill btn-send mb-3" href="{{ route('front.comprehensive.details.submit',['applicationId'=>$applicationDetails->id,'id'=>$details->id]) }}">
                    ...
                    <div class="card">
                        <div class="card-body" style="padding: 1em 1em !important;">
                            <div class="col-md-12">
                                ...
                                <form class="contact-form needs-validation" method="post" action="{{ route('front.comprehensive.upload',$applicationDetails->id) }}" novalidate enctype="multipart/form-data">
                                    @csrf
                                    <div class="row gx-4">
                                        <div class="col-md-12">
                                            <div class="form-floating mb-4">
                                                <div class="v"> National ID/Passport(Pdf,Word Doc or Image)</div>
                                                <input id="form_name" type="file" name="identification" class="form-control"  required>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-floating mb-4">
                                                ...
                                                <input id="form_name" type="file" name="kra" class="form-control"  required>
                                                {{--                                                                    <label for="form_name">Vehicle current value *</label>--}}
                                                @if ($errors->has('kra'))
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-floating mb-4">
                                                ...
                                                <input id="form_name" type="file" name="logbook" class="form-control"  required>
                                                {{--                                                                    <label for="form_name">Vehicle current value *</label>--}}
                                                @if ($errors->has('logbook'))
                                                    <div class="invalid-feedback"> {{ $errors->first('logbook') }} </div>
                                                @endif
                                            </div>
                                        </div>
                                        <!-- /column -->
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn btn-success btn-sm rounded-pill btn-send mb-3" value="Send message">Upload documents  <i class="uil uil-upload"></i> </button>
                                        </div>
                                        <div class="col-12 text-center">
                                            OR
                                        </div>
