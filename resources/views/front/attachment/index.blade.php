    ...
    <div class="page-banner-area blog-page-are">
        <div class="container">
            <div class="single-page-banner-content">
                <h1>Student Personal Accident</h1>
                <ul>
                    <li>
                        <a href="{{ route('home') }}">Home</a>
                    </li>
                    <li>Student Personal Accident</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form method="post" action="{{ route('front.attachment.submit') }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input id="idNumber" type="text" name="idNumber"
                                            value="{{ old('idNumber') }}" class="form-control"
                                            placeholder="ID Number" required data-error="Please enter ID Number">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
