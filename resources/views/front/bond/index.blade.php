            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form method="post" action="{{ route('front.bond.submit') }}">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input type="text" id="companyName" name="companyName"
                                            value="{{ old('companyName') }}" class="form-control"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input type="text" id="physicalAddress" name="physicalAddress"
                                            value="{{ old('physicalAddress') }}" class="form-control"
                                            placeholder="Physical Address" required
                                            data-error="Please enter your Physical Address">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input type="text" id="email" name="tenderName"
                                            value="{{ old('tenderName') }}" class="form-control"
                                            placeholder="Tender Name" required data-error="Please enter Tender Name">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input type="text" id="email" class="form-control"
                                            placeholder="Tender Number" name="tenderNumber"
                                            value="{{ old('tenderNumber') }}" required
                                            data-error="Please enter Tender Number">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input id="advertisingCompany" type="text" name="advertisingCompany"
                                            value="{{ old('advertisingCompany') }}"
                                            placeholder="Company Advertising Tender" required
                                            data-error="Please enter Company advertising Tender" class="form-control">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input type="text" id="address" name="address"
                                            value="{{ old('address') }}" placeholder="Company Advertising Address"
                                            required data-error="Please enter Company advertising Address"
                                            class="form-control">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input id="tenderValue" type="number" name="contractPrice"
                                            value="{{ old('contractPrice') }}" class="form-control"
                                            placeholder="Tender Value" required
                                            data-error="Please enter your Tender Value">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input id="bondValue" type="number" name="bondValue"
                                            value="{{ old('bondValue') }}" class="form-control"
                                            placeholder="Bond Value" required
                                            data-error="Please enter your Bond Value">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <input id="period" type="number" name="period"
                                            value="{{ old('period') }}" class="form-control"
                                            placeholder="Validity (In days) *" required
                                            data-error="Please enter Bond Validity">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
