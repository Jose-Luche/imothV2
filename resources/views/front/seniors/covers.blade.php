    ...
    <div class="features-area pt-100 pb-70">
        <div class="container">
            <div class="section-title">
                <span class="top-title">Available Seniors Medical Insurance Covers</span>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.selected-plan-limit').click(function (){
                ...
                $.ajax({
                    method: 'GET',
                    url: '/covers/seniors/update-my-application/'+applicationId+'/'+limitId+'/'+inpatientBasicPremium+'/'+currentSelectedOutpatient+'/'+currentSelectedDental+'/'+currentSelectedOptical+'/'+currentSelectedMaternity,
                    success: function(res){
                        if(res == 'error'){
                            alert('There was an error trying to Select a Cover');
                        }else{
                            window.location = '/covers/seniors/details/'+res;
                        }
                    }
                });
            });
                ...
                if($(this).is(':checked')){
                    ...
                    $('.outpatient-plan-limits').change(function(){
                        ...
                        if(opLimit != ""){
                            ...
                            $.ajax({
                                method: 'GET',
                                url: '/covers/seniors/update-outpatient-premium-details/{{$applicationDetails->id}}/'+activateOp+'/'+opLimit+'/'+pp_pf+'/'+insurerId,
                                success: function(res){
                    ...
                    $.ajax({
                        method: 'GET',
                        url: '/covers/seniors/update-outpatient-premium-details/{{$applicationDetails->id}}/'+activateOp+'/'+opLimit+'/'+pp_pf,
                        success: function(res){
                            currentSelectedOutpatient.val(res).trigger('change');
                        }
                    });
                ...
                if($(this).is(':checked')){
                    ...
                    $('.dental-plan-limits').change(function(){
                        ...
                        if(dentalLimit != ""){
                            ...
                            $.ajax({
                                method: 'GET',
                                url: '/covers/seniors/update-dental-premium-details/{{$applicationDetails->id}}/'+activateDental+'/'+dentalLimit+'/'+insurerId,
                                success: function(res){
                    ...
                    $.ajax({
                        method: 'GET',
                        url: '/covers/seniors/update-dental-premium-details/{{$applicationDetails->id}}/'+activateDental+'/'+dentalLimit,
                        success: function(res){
                            currentSelectedDental.val(res).trigger('change');
                        }
                    });
                ...
                if($(this).is(':checked')){
                    ...
                    $('.optical-plan-limits').change(function(){
                        ...
                        if(opticalLimit != ""){
                            ...
                            $.ajax({
                                method: 'GET',
                                url: '/covers/seniors/update-optical-premium-details/{{$applicationDetails->id}}/'+activateOptical+'/'+opticalLimit+'/'+insurerId,
                                success: function(res){
                    ...
                    $.ajax({
                        method: 'GET',
                        url: '/covers/seniors/update-optical-premium-details/{{$applicationDetails->id}}/'+activateOptical+'/'+opticalLimit,
                        success: function(res){
                            currentSelectedOptical.val(res).trigger('change');
                        }
                    });
                ...
                if($(this).is(':checked')){
                    ...
                    $('.maternity-plan-limits').change(function(){
                        ...
                        if(maternityLimit != ""){
                            ...
                            $.ajax({
                                method: 'GET',
                                url: '/covers/seniors/update-maternity-premium-details/{{$applicationDetails->id}}/'+activateMaternity+'/'+maternityLimit+'/'+insurerId,
                                success: function(res){
                    ...
                    $.ajax({
                        method: 'GET',
                        url: '/covers/seniors/update-maternity-premium-details/{{$applicationDetails->id}}/'+activateMaternity+'/'+maternityLimit,
                        success: function(res){
                            currentSelectedMaternity.val(res).trigger('change');
                        }
                    });
