                                    ...
                                    <div class="single-features-card bg-color-2">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <a
                                                    href="{{ route('front.pages.quotations.quotation-pdf', ['applicationId' => $applicationDetails->id, 'id' => $details->id, 'lastExpense']) }}">
                                                    <span
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <a class="btn btn-outline-aqua btn-sm rounded-pill btn-send mb-3"
                                                    href="{{ route('front.lastExpense.details.submit', ['applicationId' => $applicationDetails->id, 'id' => $details->id]) }}">
                                                    <span
