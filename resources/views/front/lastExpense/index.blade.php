                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12" style="padding: 20px">
                                        <div class="form-group">
                                            Do you have a Spouse? <input type="checkbox" id="hasSpouse" name="hasSpouse" value="yes"
                                ...
                                <div class="row" style="display: none" id="children-number">
                                    <div class="col-lg-8 col-md-8">
                                        <div class="form-group">
                                            <input type="text" id="childOne" name="childOne"
                                                   ...
                                                   data-error="Enter Child One Name">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="form-group">
                                            <input type="text" id="childOneAge" class="form-control"
                                                   placeholder="Child One Age" name="childOneAge" value="{{ old('childOneAge') }}"
                                    ...
                                    <div class="row" id="child-one-buttons">
                                        <div class="col-lg-6 col-md-6">
                                            <button type="button" class="btn btn-success" id="add-child-two" >Add Child Two</button>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <button type="button" class="btn btn-danger" id="remove-child-one">Remove Child One</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="child-two-div" style="display: none">
                                        <div class="col-lg-8 col-md-8">
                                            <div class="form-group">
                                                <input type="text" id="childTwo" name="childTwo"
                                                       ...
                                                       data-error="Enter Child Two Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="childTwoAge" class="form-control"
                                                       placeholder="Child Two Age" name="childTwoAge" value="{{ old('childTwoAge') }}"
                                        ...
                                        <div  class="row" id="child-two-buttons">
                                            <div class="col-lg-6 col-md-6">
                                                <button type="button" class="btn btn-success" id="add-child-three">Add Child Three</button>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <button type="button" class="btn btn-danger" id="remove-child-two" >Remove Child Two</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="child-three-div" style="display: none">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="childThreeAge" class="form-control"
                                                       placeholder="Child Three Age" name="childThreeAge" value="{{ old('childThreeAge') }}"
                                        ...
                                        <div  class="row" id="child-three-buttons">
                                            <div class="col-lg-6 col-md-6">
                                                <button type="button" class="btn btn-success" id="add-child-four">Add Child Four</button>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <button type="button" class="btn btn-danger" id="remove-child-three" >Remove Child Three</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="child-four-div" style="display: none">
                                        <div class="col-lg-8 col-md-8">
                                            <div class="form-group">
                                                <input type="text" id="childFour" name="childFour"
                                                       ...
                                                       placeholder="Child Four Name"
                                                       data-error="Enter Child Four Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="childFourAge" class="form-control"
                                                       placeholder="Child Four Age" name="childFourAge" value="{{ old('childFourAge') }}"
                                        ...
                                        <div  class="row" id="child-four-buttons">
                                            <div class="col-lg-6 col-md-6">
                                                <button type="button" class="btn btn-success" id="add-child-five">Add Child FIve</button>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <button type="button" class="btn btn-danger" id="remove-child-four" >Remove Child Four</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="child-five-div" style="display: none">
                                        <div class="col-lg-8 col-md-8">
                                            <div class="form-group">
                                                <input type="text" id="childFive" name="childFive"
                                                       ...
                                                       placeholder="Child Five Name"
                                                       data-error="Enter Child Five Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="childFiveAge" class="form-control"
                                                       placeholder="Child Five Age" name="childFiveAge" value="{{ old('childFiveAge') }}"
                                        ...
                                        <div  class="row" id="child-five-buttons">
                                            <div class="col-lg-6 col-md-6">
                                                <button type="button" class="btn btn-success" id="add-child-six">Add Child Six</button>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <button type="button" class="btn btn-danger" id="remove-child-five" >Remove Child Five</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="child-six-div" style="display: none">
                                        <div class="col-lg-8 col-md-8">
                                            <div class="form-group">
                                                <input type="text" id="childSix" name="childSix"
                                                       ...
                                                       placeholder="Child Six Name"
                                                       data-error="Enter Child Six Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="childSixAge" class="form-control"
                                                       placeholder="Child Five Age" name="childSixAge" value="{{ old('childSixAge') }}"
                                        ...
                                        <div  class="row" id="child-six-buttons">
                                            <div class="col-lg-6 col-md-6">
                                                <button type="button" class="btn btn-danger" id="remove-child-six" >Remove Child Six</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            <div class="form-group">
                                                <input type="text" id="fatherName" name="fatherName"
                                                       ...
                                                       data-error="Enter Father's Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="fatherAge" class="form-control"
                                                       placeholder="Father Age" name="fatherAge" value="{{ old('fatherAge') }}"
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            <div class="form-group">
                                                <input type="text" id="motherName" name="motherName"
                                                       ...
                                                       data-error="Enter Mother's Name">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="motherAge" class="form-control"
                                                       placeholder="Mother Age" name="motherAge" value="{{ old('motherAge') }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12" style="padding: 20px">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" id="hasParentsInLaws" name="hasParentsInLaws" value="yes"
                                                   style="width: 20px; height: 20px; margin-left: 10px">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="fatherInLawAge" class="form-control"
                                                       placeholder="Father in Law Age" name="fatherInLawAge" value="{{ old('fatherInLawAge') }}"
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="form-group">
                                                <input type="text" id="motherInLawAge" class="form-control"
                                                       placeholder="Mother in Law Age" name="motherInLawAge" value="{{ old('motherInLawAge') }}"
                                    ...
                                    <div class="form-group">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="gridCheck">
                                                Accept <a href="{{ asset('frontend/assets/last_expense.pdf') }}" target="_blank">Terms Of Services</a> And<a
                                                    href="{{ asset('frontend/assets/privacy.pdf') }}" target="_blank">Privacy Policy</a>
                                            </label>
