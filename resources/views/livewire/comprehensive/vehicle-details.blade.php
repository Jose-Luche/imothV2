<div>
    <form class="contact-fsorm needs-validation" method="post" wire:submit.prevent="submit" novalidate>
        <div class="messages"></div>
        <div class="row gx-4">
            <div class="col-md-12">
                <div class="form-floating mb-4">
                    <input id="form_name" wire:model="value" wire:keyup="updateValue"
            ...
            <div class="col-md-12">
                <div class="form-select-wrapper mb-4">
                    <select class="form-select" wire:model="vehicleUse"  id="form-select"  name="vehicleUse" required>
            ...
            <div class="col-md-12">
                <div class="form-select-wrapper mb-4">
                    <select  name="carMake" wire:model="carMake" class="form-select" id="form-select"  required>
            ...
            <div class="col-md-12">
                <div class="form-select-wrapper mb-4">
                    <select class="form-select" wire:model="year" id="form-select"  name="year" required>
                        <option selected disabled value="">Vehicle year of manufacture *</option>
            ...
            <div class="col-md-12">
                <div class="form-floating mb-4">
                    <input id="form_name" wire:model="date" type="date" name="date" class="form-control"  required>
