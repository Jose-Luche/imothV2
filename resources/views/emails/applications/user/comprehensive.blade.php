                            ...
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Hi {{ $details->firstName }}, we received a insurance application.
                                    </p>
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Vehicle Value : Ksh {{ number_format($details->value) }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Vehicle Make : Ksh {{ $details->carMake }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Expected start Date : {{ $details->date }}
                                    </p>
                                    <h2 style="line-height: 24px; margin-bottom:20px;">
                                        <u>Cover Details.</u>
                                    </h2>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Insurance Company : {{ $details->comprehensiveDetails->company->name }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Amount Payable : Ksh {{ number_format($details->amountPayable) }}
                                    </p>
                                    <p>
                                        <strong>Details:</strong><br>
                                        {!! $details->comprehensiveDetails->details  !!}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
