                            ...
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Hi {{ $details->firstName }}, we received your <strong>Group/Family personal accident Insurance</strong> application.
                                    </p>
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Number of children : {{ $details->numberOfChildren }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Children Ages : {{ $details->childrenAges }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Spouse Name : {{ $details->spouseName }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Spouse Age : {{ $details->spouseAge }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
