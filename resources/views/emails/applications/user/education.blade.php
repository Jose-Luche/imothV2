                            ...
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Hi {{ $details->name }}, we received your <strong>Education Insurance</strong> application.
                                    </p>
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Child's Age Bracket {{ $details->ageBracket }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        How much would you like to save? : {{ $details->amount }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
