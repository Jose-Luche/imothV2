                ...
                <tr>
                    <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                        ...
                        <div style="line-height: 35px">
                            ...
                            <span style="color: #3d4ad2;">{{ env('APP_NAME') }}</span>
                            ...
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Hi {{ $details->firstName }}, we received your <strong>Family/Individual Insurance</strong> application.
                                    </p>
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Annual Cover Limit  Ksh {{ number_format($details->coverLimit) }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Do you have any pre-existing medical condition? : {{ $details->condition }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Do you or any of your dependents have any pre-existing medical condition?  : {{ $details->dependentCondition }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Date Of Birth (D.O.B) :  {{ $details->dob }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Spouse D.O.B :  {{ $details->spouseDob }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Number of children(0-18 years) :  {{ $details->children }}
                                    </p>
                            ...
                            <tr>
                                <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    <div style="line-height: 24px;">
                                        ...
                                        <span style="color: #333333;">{{ env('APP_NAME') }}</span>
