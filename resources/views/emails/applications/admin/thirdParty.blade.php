                                ...
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        A client has <strong>
                                            ...
                                            @else
                                                created
                                            @endif a Third Party Insurance</strong> application
                                    </p>
                                    ...
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Insurance Company : {{ $details->thirdPartyDetails->company->name }}
                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                    ...
                                    <p>
                                        ...
                                        {!! $details->thirdPartyDetails->details  !!}
                                    </p>
                                    @endif
                                    <p style="line-height: 24px; margin-bottom:20px;">
