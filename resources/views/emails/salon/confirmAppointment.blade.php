...
<head>
    ...
    <title>{{ env('PROJECT_TITTLE') }}</title>
                ...
                <tr>
                    <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                        ...
                        <div style="line-height: 35px">
                            ...
                            <span style="color: #5caad2;">{{ env('PROJECT_TITTLE') }}</span>
                            ...
                            <tr>
                                <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    ...
                                    <p style="line-height: 24px; margin-bottom:15px;">
                                        ...
                                        Hello {{ $app->client->firstName }},

                                    </p>
                                    <p style="line-height: 24px; margin-bottom:20px;">
                                        Your appointment request to <strong>{{ $app->salon->name }}</strong> has been approved.
                                    </p>
                                    <h4 style="text-align: center">Details</h4>
                                    @foreach($app->services as $service)
                                        <strong>Service : {{ $service->details->name }} </strong><br>
                                        <strong>Date : {{ Carbon\Carbon::parse($app->date)->format('l,F Y') }}</strong><br>
                                        <strong>Time : {{ $service->startTime }}</strong><br>
                                        <strong style="text-align: center">Cost : <quote> Ksh {{ $service->details->price }}</quote> </strong><br>
                                    @endforeach
                                    <br>
                                    <p>
                                     <strong>Location : <quote>{{ $app->salon->location }}</quote> </strong>
                                    </p>
                                    <h6>Notes</h6>
                                    <blockquote>{{ $app->notes }}</blockquote><br>

                                    <p>Login to view more details.</p>
                                    <br>
                                    <br>
                                    <table border="0" align="center" width="180" cellpadding="0" cellspacing="0" bgcolor="green" style="margin-bottom:20px;">
                                        ...
                                        <tr>
                                            <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                ...
                                                <div style="line-height: 22px;">
                                                    <a href="{{ route('user.login')}}" style="color: #ffffff; text-decoration: none;">Login</a>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                                ...
                                                <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                    ...
                                                    Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">{{ env('CONTACT_EMAIL') }}</a>
                            ...
                            <tr>
                                <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    <div style="line-height: 24px;">
                                        ...
                                        <span style="color: #333333;">{{ env('PROJECT_TITTLE') }}</span>
