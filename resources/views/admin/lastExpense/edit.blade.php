                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <form id="demo-form" data-parsley-validate="" method="post"
                                action="{{ route('admin.lastExpense.update', $details->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="max_children" class="form-control" id="max_children"
                                                placeholder="Max Children Free Limit"
                                                value="{{ $details->max_child_limit }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="extra_premium" class="form-control"
                                                id="extra_premium" placeholder="Extra Child Premium"
                                                value="{{ $details->additional_child_premium }}">
