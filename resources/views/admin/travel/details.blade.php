                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.travel') }}">Travel Insurance Covers</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                               ...
                                               <h4 class="mt-0 mb-1"><strong>Created On: </strong>{{ $details->created_at->format('d M, Y') }}</h4>
                                                ...
                                                <span>
                                                    <a  href="{{ route('admin.travel.edit',$details->id) }}" class="btn btn-outline-success btn-sm"> Edit <i class="fa fa-edit"></i></a> |
