                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <form id="demo-form" data-parsley-validate="" method="post"
                                action="{{ route('admin.thirdParty.update', $details->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type">
                                                <option {{ $details->type === 'Annually' ? 'selected' : '' }}
                                                    value="Annually">Annually</option>
                                                <option {{ $details->type === 'Monthly' ? 'selected' : '' }} value="Monthly">
                                                    Monthly</option>
                                            </select>
                                            @if ($errors->has('type'))
                                                <span class="help-block">
