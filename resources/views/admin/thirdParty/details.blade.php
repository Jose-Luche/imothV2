                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.thirdParty') }}">Third Party Covers</a></li>
                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <h4 class="mt-0 mb-1"><strong>Standard Fee : </strong>Ksh {{ $details->rate }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>Policy Duration : </strong>{{ $details->type }}</h4>
{{--                                                <h4 class="mt-0 mb-1"><strong>Min Car Year : </strong>{{ $details->minYear }}</h4>--}}
                                                ...
                                                <span>
                                                    <a  href="{{ route('admin.thirdParty.edit',$details->id) }}" class="btn btn-outline-success btn-sm"> Edit <i class="fa fa-edit"></i></a> |
