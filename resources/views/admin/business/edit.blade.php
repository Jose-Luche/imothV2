                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <form id="demo-form" data-parsley-validate="" method="post" action="{{ route('admin.business.update',$details->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="firstname">Min Rate :</label>
                                            <input type="text"  name="minRate" class="form-control" id="location" placeholder="Min Rate" value="{{ $details->minRate }}">
