...
@section('title','New Business Insurance')
@section('content')
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Business Insurance.</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Business Insurance.</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <form id="demo-form" data-parsley-validate="" method="post" action="{{ route('admin.business.submit') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="rate" class="form-control" id="location" placeholder="Rate in %" value="{{ old('rate') }}">
                                            @if ($errors->has('rate'))
                                                <span class="help-block">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="minRate" class="form-control" id="location" placeholder="Min Rate" value="{{ old('minRate') }}">
