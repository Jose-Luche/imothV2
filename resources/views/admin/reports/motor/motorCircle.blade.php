...
@section('title','Motor Circle Insurance')
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Motor Circle Insurance'</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Motor Circle Insurance'</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                    ...
                                    <table class="table table-centered table-striped" id="products-datatable">
                                        ...
                                        @foreach($items as $count=>$row)
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        <a  href="{{ route('admin.reports.motorCircle.details',$row->id) }}" class="btn btn-success btn-sm"> Details </a>
                                                    </span>
                                                </td>
                                            </tr>
                                        @endforeach
