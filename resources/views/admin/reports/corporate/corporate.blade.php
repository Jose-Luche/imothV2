                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Comprehensive Insurance Applications List</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                    ...
                                    <table class="table table-centered table-striped" id="products-datatable">
                                        ...
                                        @foreach($items as $count=>$row)
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        <a  href="{{ route('admin.reports.corporate.details',$row->id) }}" class="btn btn-success btn-sm"> Details </a>
                                                    </span>
                                                </td>
                                            </tr>
                                        @endforeach
