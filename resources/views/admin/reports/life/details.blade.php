                                            ...
                                            <div class="col-lg-8">
                                                <h4 class="mt-0 mb-1"><strong>Insurance Type : </strong>
                                                    ...
                                                    @elseif($details->type == 2)
                                                        Education Insurance
                                                    @endif</h4>
                                                <h4 class="mt-0 mb-1"><strong>Client Name : </strong>{{ $details->name }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>Phone: </strong>{{ $details->phone }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>Email: </strong>{{ $details->email }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>Age: </strong>{{ $details->ageBracket }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>Amount: </strong>{{ $details->amount }}</h4>
    ...
    <script>
        function deleteCompany(id) {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        var url = '{{ route("admin.reports.life.delete", ":id") }}';
