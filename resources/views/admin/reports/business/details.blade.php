...
@section('title',$details->firstName." ".$details->lastName)
@section('content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">{{ $details->firstName." ".$details->lastName }}</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <h4 class="mt-0 mb-1"><strong>Phone: </strong>{{ $details->mobile }}</h4>
