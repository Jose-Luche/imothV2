                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <h4 class="mt-0 mb-1"><strong>Cover Limit: </strong>Ksh {{ number_format($details->coverLimit) }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>Pre-existing medical condition: </strong>{{ $details->condition }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>DOB: </strong>{{ $details->dob }}</h4>
                                                @if($details->type == 2)
                                                <h4 class="mt-0 mb-1"><strong>Dependent with Pre-existing medical condition: </strong>{{ $details->dependentCondition }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>Spouse Dob: </strong>{{ $details->spouseDob }}</h4>
    ...
    <script>
        function deleteCompany(id) {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        var url = '{{ route("admin.reports.health.delete", ":id") }}';
