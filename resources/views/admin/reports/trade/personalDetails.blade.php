                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <h4 class="mt-0 mb-1"><strong>Profession: </strong>{{ $details->profession }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>Amount: </strong>Ksh {{ number_format($details->amount) }}</h4>
    ...
    <script>
        function deleteCompany(id) {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        var url = '{{ route("admin.reports.indemnity.delete", ":id") }}';
