                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('admin.limits.nonmotor.store', $id) }}" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="product"  class="form-control" required>
                                                    @if($clause->product != null)
                                                        <option value="{{$clause->product}}">{{$clause->product}}</option>
                                                    @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="class"  class="form-control" required>
                                                    @if($clause->class != null)
                                                        <option value="{{$clause->class}}">{{$clause->class}} Covers</option>
                                                    @endif
