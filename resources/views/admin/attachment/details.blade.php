                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.attachment') }}">Attachment</a></li>
                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <h4 class="mt-0 mb-1"><strong>Three month fee : </strong>Ksh {{ $details->three_month }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>Six month fee : </strong>Ksh {{ $details->six_month }}</h4>
                                                <h4 class="mt-0 mb-1"><strong>One year fee : </strong>Ksh {{ $details->one_year }}</h4>
...
{{--                                                <h4 class="mt-0 mb-1"><strong>Min Car Year : </strong>{{ $details->minYear }}</h4>--}}
                                                ...
                                                <span>
                                                    <a  href="{{ route('admin.attachment.edit',$details->id) }}" class="btn btn-outline-success btn-sm"> Edit <i class="fa fa-edit"></i></a> |
                                ...
                                <div class="">
                                    <table class="table table-centered table-hover mb-0">
                                        ...
                                        @foreach($details->benefits as $details)
                                            <tr>
                                                <td>{{ $details->name }}</td>
                                                <td>{{ $details->type == 1 ?"":"Ksh" }} {{ $details->rate }} {{ $details->type == 1 ?"%":"" }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
