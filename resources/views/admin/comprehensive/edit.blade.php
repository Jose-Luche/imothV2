                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <form id="demo-form" data-parsley-validate="" method="post"
                                action="{{ route('admin.comprehensive.update', $details->id) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="category"
                                                ...
                                                @if ($details->category)
                                                    <option value="{{ $details->category }}">
                                                        {{ ucwords($details->category) }} Use</option>
                                                @endif
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Benefit Rate" name="benefitRate[]"
                                                                value="{{ $benefit->rate }}" required>
                                                            <input type="hidden" value="1"
                                                                name="benefitRateType[]">
                                                            <input type="hidden" value="1" name="type[]">
                                                            <input type="hidden" value="{{ $benefit->id }}"
                                                                name="bId[]">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
