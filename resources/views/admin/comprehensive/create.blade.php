                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Comprehensive Insurance</a>
                                    </li>
                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <form id="demo-form" data-parsley-validate="" method="post"
                                action="{{ route('admin.comprehensive.submit') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            placeholder="Minimum Premium" name="benefitMinimum[]"
                                                            required>
                                                    </div>
                                                </div>
                                                {{--                                                <div class="col-md-3"> --}}
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group" style="padding-top: 25px;">
                                                            <button type="button" name="add" id="0"
                                                                class="btn btn-outline-danger btn_remove">Remove <i
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <button type="button" name="add" id="add"
                                                        class="btn btn-success">Add Excess Benefit <i
                                                            class="fa fa-plus-circle"></i> </button>

                                                    <button type="button" name="add2" id="add2"
                                                        class="btn btn-success">Add Addon Benefit <i
                                                            class="fa fa-plus-circle"></i> </button>
