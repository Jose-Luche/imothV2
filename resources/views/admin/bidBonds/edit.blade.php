                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Edit Bid Bonds.</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Edit Bid Bonds.</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <form id="demo-form" data-parsley-validate="" method="post" action="{{ route('admin.bidBonds.update',$details->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
