                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <h4 class="mt-0 mb-1"><strong>Min Rate : </strong>Ksh {{ $details->minRate }}</h4>
                                               <h4 class="mt-0 mb-1"><strong>Created On: </strong>{{ $details->created_at->format('d M, Y') }}</h4>
                                                ...
                                                <span>
                                                    <a  href="{{ route('admin.bidBonds.edit',$details->id) }}" class="btn btn-outline-success btn-sm"> Edit <i class="fa fa-edit"></i></a> |
